 ...
 * @Aythor lucksoul 王吉慧
 * @date 2022/3/5 23:32
 * @description 消费者  手动 异步提交
 */
public class KafkaMyConsumerOffSetNoAutoUnAsyn {
    public static void main(String[] args) {
        ...
        //AUTO_OFFSET_RESET_CONFIG 和组名必须同时满足，才可以从新消费
        //2.创建消费者
        ...
        while (true) {
            ...
            consumer.commitAsync(new OffsetCommitCallback() {
                ...
                public void onComplete(Map<TopicPartition, OffsetAndMetadata> map, Exception e) {
                    System.out.println("data map " + new Gson().toJson(map));
                }
            });
        }
